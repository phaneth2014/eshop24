                ...
                <div className="wrap-footer-item">
                  ...
                  <div className="item-content">
                    <div className="wrap-list-item social-network">
                      <ul>
                        <li>
                          <a href="#" className="link-to-item" title="twitter">
                            <i className="fa fa-twitter" aria-hidden="true" />
                          </a>
                        </li>
                        <li>
                          <a href="#" className="link-to-item" title="facebook">
                        ...
                        <li>
                          <a href="#" className="link-to-item" title="vimeo">
              ...
              <div className="back-link-box">
                ...
                <div className="back-link-row">
                  <ul className="list-back-link">
                    ...
                    <li>
                      <a href="#" className="redirect-back-link" title="mobile">
                        Mobiles
                      </a>
                    </li>
                    <li>
          ...
          <div className="container">
            ...
            <div className="coppy-right-item item-right">
              <div className="wrap-nav horizontal-nav">
                <ul>
                  <li className="menu-item">
                    <a href="about-us.html" className="link-term">
                      About us
                    </a>
                  </li>
                  <li className="menu-item">
